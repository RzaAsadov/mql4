...
sudo su mt4_development -c "cp -rf /home/zrid/Hero/mq4/indicators/$1.mq4 /home/mt4_development/MT4/$2/MQL4/Indicators/"
...
sudo su mt4_development -c "/usr/bin/wine /home/mt4_development/MT4/$2/MQL4/build/compile_indicator.bat $1 $2 &> /dev/null &"
sudo su mt4_development -c "/usr/bin/dos2unix /home/mt4_development/MT4/$2/MQL4/Indicators/$1.log &> /dev/null &"

cat /home/mt4_development/MT4/$2/MQL4/Indicators/$1.log | grep -e error -e Result
